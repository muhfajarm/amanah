...
<html lang="en">
  <head>
    ...
    <body class="body">
      ...
      <a href="./faq.php">Cara Penggunaan</a>
          ...
          <?php if (isset($_SESSION["users"])): ?>
            <ul class="nav-item dropdown mr-5">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="./user/dashboard/index.php?email=<?= $_SESSION['email']; ?>">Dashboard</a>
                <a class="dropdown-item" href="./user/riwayat/riwayat.php">Riwayat</a>
