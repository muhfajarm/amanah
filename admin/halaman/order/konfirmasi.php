<?php 
	...
	$sql = "SELECT * FROM pembayaran JOIN orders ON pembayaran.orders_id=orders.id_orders WHERE id_orders='$id_order'";
...
if (isset($_POST['konfirmasi'])) {
	...
	$status = $_POST['status'];
 	...
 	$sql_konfirmasi = "UPDATE orders SET resi='$resi', status_order='$status' WHERE id_orders='$id_order'";
